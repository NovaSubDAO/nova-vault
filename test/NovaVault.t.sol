...
contract NovaVaultTest is Test {
    address public CLPOOL = 0x94c0A04C0d74571aa9EE25Dd6c29E2A36f5699aE;
    address public POOL = 0xe899B1B1d88E0198c668bb5500A0a4eDA12AE3c8;
    ...
    function setUp() public {
        veloCLPool = IVelodromeCLPool(CLPOOL);
        veloToken0 = veloCLPool.token0();
        veloToken1 = veloCLPool.token1();
        if (veloToken0 == sDAI) {
